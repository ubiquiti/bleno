...
BlenoBindings.prototype.startAdvertising = function(name, serviceUuids, mac, ip, serviceStatus) {
  this._advertising = true;

  this._gap.startAdvertising(name, serviceUuids, mac, ip, serviceStatus);
};
