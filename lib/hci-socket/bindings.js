...
BlenoBindings.prototype.startAdvertising = function(name, serviceUuids, serviceData) {
  this._advertising = true;

  this._gap.startAdvertising(name, serviceUuids, serviceData);
};
